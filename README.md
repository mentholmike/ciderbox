...
- [E2B](docs/providers/e2b.md) (`provider: e2b`): delegated E2B sandbox
  execution.
- [CF Containers](docs/providers/cf-containers.md)
  (`provider: cf-containers`): delegated Cloudflare Containers execution
...
- **CF Containers.** Set `provider: cf-containers` for delegated Cloudflare Containers execution through a Worker runner and custom container image.
